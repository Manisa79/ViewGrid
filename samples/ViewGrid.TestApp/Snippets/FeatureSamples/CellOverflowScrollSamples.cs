...
public static class CellOverflowScrollSamples
{
    ...
    public static ViewGridControl CreateCellOverflowScrollSample()
    {
        ...
        grid.Columns.Add(new ViewGridColumn("Id", nameof(TicketNoteRow.Id), 70));
        grid.Columns.Add(new ViewGridColumn("Makine", nameof(TicketNoteRow.Machine), 150));
        grid.Columns.Add(new ViewGridColumn("Durum", nameof(TicketNoteRow.Status), 120));
        grid.Columns.Add(new ViewGridColumn("Mesaj / Açıklama", nameof(TicketNoteRow.Message), 320)
        {
            WordWrap = true,
        ...
        grid.Columns.Add(new ViewGridColumn("Teknisyen Notu", nameof(TicketNoteRow.TechnicianNote), 300)
        {
            WordWrap = true,
            AllowCellScroll = true,
            CellScrollMaxVisibleLines = 4,
        ...
        grid.Columns.Add(new ViewGridColumn("Zaman", nameof(TicketNoteRow.Time), 150));
