...
public static class GLVColumnBehaviorFilterSamples
{
    ...
    public static FastViewGridControl CreateDefaultFilterButtonSample()
    {
    ...
    public static FastViewGridControl CreateDesignerLikeConfigurationSample()
    {
        ...
        grid.SetColumnFilter(new ViewGridColumnFilter
        {
            AspectName = "Status",
