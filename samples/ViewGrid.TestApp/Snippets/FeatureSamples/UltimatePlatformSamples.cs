...
public static class UltimatePlatformSamples
{
    ...
    public static ViewGridControl CreateUltimateSample()
    {
        ...
        grid.Columns.Add(new ViewGridColumn { Header = "Id", AspectName = "Id", Width = 70 });
        grid.Columns.Add(new ViewGridColumn { Header = "Durum", AspectName = "Status", Width = 120 });
        grid.Columns.Add(new ViewGridColumn { Header = "Makine", AspectName = "Machine", Width = 140 });
        grid.Columns.Add(new ViewGridColumn { Header = "Öncelik", AspectName = "Priority", Width = 90 });
        grid.Columns.Add(new ViewGridColumn { Header = "Başlık", AspectName = "Title", Width = 260 });
        grid.Columns.Add(new ViewGridColumn { Header = "Yaş", Formula = "IF(Priority>=3,'Acil','Normal')", UseFormula = true, Width = 90 });
        ...
        grid.Actions.Add(new ViewGridActionStep
        {
