...
public sealed class PanoCompatSampleForm : Form
{
    ...
    public PanoCompatSampleForm()
    {
        Text = "Pano/GLV uyumluluk örnekleri - SetObjects / events / seçim / checked / sort";
        Width = 1100;
        Height = 680;
    ...
    {
        _grid.Columns.Add(new PanoColumn("Seç", nameof(CompatRow.Checked), 54) { Kind = PanoColumnKind.CheckBox, Editable = true });
        _grid.Columns.Add(new PanoColumn("Id", nameof(CompatRow.Id), 70) { TextAlign = ContentAlignment.MiddleRight });
        _grid.Columns.Add(new PanoColumn("Kod", nameof(CompatRow.Code), 130));
        _grid.Columns.Add(new PanoColumn("Ad", nameof(CompatRow.Name), 220) { FillFreeSpace = true });
        _grid.Columns.Add(new PanoColumn("Durum", nameof(CompatRow.State), 110));
        _grid.Columns.Add(new PanoColumn("Oran", nameof(CompatRow.Rate), 90) { TextAlign = ContentAlignment.MiddleRight });
    }
