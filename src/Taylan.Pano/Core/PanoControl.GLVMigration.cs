...
/// <summary>Pano hücre düzenleme tetikleme modu.</summary>
...
/// <summary>Pano model filtresi kontratı.</summary>
public interface IGLVModelFilter
{
    bool Filter(object modelObject);
}

/// <summary>Delegate tabanlı Pano model filtresi.</summary>
...
public partial class PanoControl
{
    ...
    private PanoColumn? _secondarySortColumn;
    ...
    /// <summary>Pano UseFiltering özelliği. Filtre menüsünü ve mevcut filtrelerin uygulanmasını kontrol eder.</summary>
    ...
    /// <summary>Pano CheckBoxes özelliği. CheckedAspectName verilirse checkbox kolonu otomatik hazırlanır.</summary>
    [Category("Pano - Compatibility")]
    [DefaultValue(false)]
    ...
    /// <summary>Pano CheckedAspectName özelliği. Checkbox değerinin okunacağı/yazılacağı model property adıdır.</summary>
    [Category("Pano - Compatibility")]
    [DefaultValue("")]
    ...
    /// <summary>Pano CellEditActivation özelliği.</summary>
    [Category("Pano - Compatibility")]
    ...
    /// <summary>Pano AdditionalFilter özelliği. Func, Predicate ve IGLVModelFilter destekler.</summary>
    [Browsable(false)]
    ...
    /// <summary>Pano tarafında güçlü tipli AdditionalFilter.</summary>
    [Browsable(false)]
    ...
    [Browsable(false)]
    public PanoColumn? PrimarySortColumn
    {
        get => _sortColumn;
    ...
    [Browsable(false)]
    public PanoColumn? SecondarySortColumn
    {
    ...
    /// <summary>Pano ShowGroups özelliği. GroupByAspectName ile birlikte çalışır.</summary>
    [Category("Pano - Compatibility")]
    [DefaultValue(false)]
    ...
    /// <summary>Pano EmptyListMsg özelliği.</summary>
    [Category("Pano - Compatibility")]
    ...
    public void Sort(PanoColumn column, SortOrder order = SortOrder.Ascending)
    {
    ...
    public void Sort(GLVColumn column, SortOrder order = SortOrder.Ascending) => Sort((PanoColumn)column, order);
    ...
    private const string InternalCheckBoxSelectorTag = "__PanoInternalCheckBoxSelector";

    private static bool IsCompatibilityCheckBoxSelector(PanoColumn column)
    {
        if (column == null || column.Kind != PanoColumnKind.CheckBox) return false;
    ...
    private PanoColumn? GetCompatibilityCheckBoxHostColumn()
    {
        if (!_checkBoxes) return null;

        // Pano/ListView uyumu: liste seviyesindeki CheckBoxes = true davranışı
    ...
    private bool IsCompatibilityCheckBoxHostColumn(PanoColumn? column)
    {
    ...
    private void NormalizeCompatibilityCheckBoxColumns()
    {
        ...
        if (host.Kind == PanoColumnKind.CheckBox)
        {
            host.Kind = PanoColumnKind.Text;
            host.Sortable = true;
        ...
        // Pano/ListView hissi: checkbox ve metin aynı kolon içinde rahat görünmeli.
        if (host.Width < 120)
            host.Width = 160;
