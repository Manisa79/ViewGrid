...
internal sealed class PanoCommandPaletteForm : Form
{
    ...
    public PanoCommandPaletteForm(PanoControl grid, string initialSearch)
    {
        _grid = grid;
        ...
        PanoDialogChrome.ConfigureStandardDialog(this, theme, new Size(420, 320), sizeable: true, iconKind: PanoDialogIconKind.Command);
        KeyPreview = true;
