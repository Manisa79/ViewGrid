...
public partial class PanoControl
{
    ...
    [DefaultValue(true)]
    [Description("Pano içindeki kolon, filtre, kolon seçici, auto-size, gruplama ve header checkbox işlemlerini klavye kısayolları ile erişilebilir yapar.")]
    ...
    private bool HandlePanoKeyboardAccessibilityShortcut(Keys keyData)
    {
    ...
    private PanoColumn? GetKeyboardActiveColumn()
    {
    ...
    private void EnsureColumnVisibleByKeyboard(PanoColumn col)
    {
