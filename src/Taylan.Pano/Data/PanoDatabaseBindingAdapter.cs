...
namespace Taylan.Pano.Data;

/// <summary>
/// Non-visual database binding helper. It lets Pano work like a light DataGridView layer:
/// Fill a DataTable, bind it to Pano, then push Insert/Update/Delete changes with SaveChanges().
...
/// </summary>
public sealed class PanoDatabaseBindingAdapter
{
    ...
    public PanoDatabaseBindingAdapter(DbConnection connection, DbDataAdapter adapter, DbCommandBuilder commandBuilder)
    {
    ...
    public void BindTo(PanoControl grid, bool autoGenerateColumns = true, string primaryKey = "")
    {
