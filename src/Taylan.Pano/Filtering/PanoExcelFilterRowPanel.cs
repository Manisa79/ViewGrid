...
/// </summary>
public sealed class PanoExcelFilterRowPanel : Panel
{
    private readonly PanoControl _grid;
    private readonly Dictionary<PanoColumn, TextBox> _editors = new();
    private readonly System.Windows.Forms.Timer _timer = new() { Interval = 180 };

    public PanoExcelFilterRowPanel(PanoControl grid)
    {
    ...
    private void ApplyFilters()
    {
        foreach (var pair in _editors)
        {
            ...
            if (string.IsNullOrWhiteSpace(text))
                ...
                _grid.SetColumnFilter(new PanoColumnFilter { AspectName = aspect, Mode = PanoFilterMode.Contains, Text = text });
        }
