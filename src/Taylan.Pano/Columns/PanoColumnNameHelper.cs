...
internal static class PanoColumnNameHelper
{
    ...
    public static bool IsDefaultColumnCaption(string? value)
    {
        ...
        return string.Equals(text, "Column", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(text, "PanoColumn", StringComparison.OrdinalIgnoreCase) ||
               string.Equals(text, "GLVColumn", StringComparison.OrdinalIgnoreCase);
    }

    public static string EnsureUnique(string baseName, IEnumerable<PanoColumn> existing)
    {
    ...
    public static string GetDesignerDisplayText(PanoColumn? column)
    {
    ...
    public static bool LooksLikeGeneratedName(string? name)
    {
        ...
        return n.StartsWith(DefaultPrefix + "Column", StringComparison.OrdinalIgnoreCase) ||
               ...
               n.StartsWith("panoColumn", StringComparison.OrdinalIgnoreCase) ||
    ...
    public static int GetNextDefaultOrdinal(IEnumerable<PanoColumn> columns)
    {
        int max = 0;
