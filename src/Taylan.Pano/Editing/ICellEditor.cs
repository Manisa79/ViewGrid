...
{
    Control CreateEditor(Control owner, Rectangle bounds, PanoColumn column, object row, object? value);
...
public sealed class ComboBoxCellEditor : ICellEditor
{
    ...
    private static void DrawImageComboItem(ComboBox combo, DrawItemEventArgs e, PanoColumn column)
    {
        e.DrawBackground();
