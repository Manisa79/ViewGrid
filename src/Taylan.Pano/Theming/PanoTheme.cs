...
public sealed class PanoTheme
{
    ...
    // v28.14.2 compatibility aliases used by newer Pano popup/dialog helpers.
    ...
    public static PanoTheme LightTheme() => new()
    {
    ...
    public static PanoTheme DarkTheme() => new()
    {
    ...
    public static PanoTheme FluentLightTheme()
    {
        var t = LightTheme();
    ...
    public static PanoTheme FluentDarkTheme()
    {
        var t = DarkTheme();
        t.UseFluentBackdrop = true;
        t.UseAcrylicEffect = true;
    ...
    public static PanoTheme FromParentColor(Color parentBackColor, Color parentForeColor)
    {
        ...
        t.IsDark = dark;
        return PanoThemeAccessibility.Normalize(t);
    }
    ...
    public static PanoTheme FromPreset(PanoThemePreset preset) => PanoThemeAccessibility.Normalize(preset switch
    {
        PanoThemePreset.System => WindowsThemeService.CurrentTheme(),
        PanoThemePreset.Light => LightTheme(),
        PanoThemePreset.Dark => DarkTheme(),
        PanoThemePreset.FluentLight => FluentLightTheme(),
        PanoThemePreset.FluentDark => FluentDarkTheme(),
        PanoThemePreset.MidnightPurple => MidnightPurpleTheme(),
        PanoThemePreset.SlateBlue => SlateBlueTheme(),
        PanoThemePreset.Graphite => GraphiteTheme(),
        PanoThemePreset.Emerald => EmeraldTheme(),
        PanoThemePreset.WarmSand => WarmSandTheme(),
        PanoThemePreset.Ocean => OceanTheme(),
        PanoThemePreset.RoseQuartz => RoseQuartzTheme(),
        PanoThemePreset.CyberNeon => CyberNeonTheme(),
        PanoThemePreset.Nord => NordTheme(),
        PanoThemePreset.Olive => OliveTheme(),
        PanoThemePreset.Steel => SteelTheme(),
        _ => WindowsThemeService.CurrentTheme()
    });

    public static PanoTheme MidnightPurpleTheme()
    {
        var t = DarkTheme();
    ...
    public static PanoTheme SlateBlueTheme()
    {
        var t = DarkTheme();
    ...
    public static PanoTheme GraphiteTheme()
    {
        var t = DarkTheme();
    ...
    public static PanoTheme EmeraldTheme()
    {
        var t = LightTheme();
    ...
    public static PanoTheme WarmSandTheme()
    {
        var t = LightTheme();
    ...
    public static PanoTheme OceanTheme()
    {
        var t = DarkTheme();
    ...
    public static PanoTheme RoseQuartzTheme()
    {
        var t = LightTheme();
    ...
    public static PanoTheme CyberNeonTheme()
    {
        var t = DarkTheme();
    ...
    public static PanoTheme NordTheme()
    {
        var t = DarkTheme();
    ...
    public static PanoTheme OliveTheme()
    {
        var t = LightTheme();
    ...
    public static PanoTheme SteelTheme()
    {
        var t = LightTheme();
