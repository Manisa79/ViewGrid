...
/// </summary>
public static class PanoWindowChrome
{
    ...
    public static void Apply(Form form, PanoTheme theme, bool preferGlassWhenAvailable = true)
    {
    ...
    public static void ApplyOnHandleCreated(Form form, Func<PanoTheme> themeProvider, bool preferGlassWhenAvailable = true)
    {
    ...
    private static void ApplyCaptionColors(IntPtr hwnd, PanoTheme theme)
    {
    ...
    private static void ApplyBackdrop(IntPtr hwnd, PanoTheme theme, bool preferGlassWhenAvailable)
    {
