...
/// Pano içindeki koyu/açık tema geçişlerinde düşük kontrastlı yazı, buton,
/// combo/textbox ve kart yüzeylerini merkezi olarak normalize eder.
/// </summary>
public static class PanoThemeAccessibility
{
    public const double NormalTextRatio = 4.5d;
    public const double LargeTextRatio = 3.0d;
    public const double SurfaceRatio = 1.18d;

    public static PanoTheme Normalize(PanoTheme? source)
    {
        var t = source ?? PanoTheme.LightTheme();
    ...
    public static Color ButtonBack(PanoTheme theme, bool primary = false)
    {
    ...
    public static Color ButtonBorder(PanoTheme theme, bool primary = false)
    {
        theme = Normalize(theme);
