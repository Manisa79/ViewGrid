...
/// <summary>
/// Standardizes ViewGrid helper/dialog windows so popup forms, chooser windows and
...
/// </summary>
public enum ViewGridDialogIconKind
{
    None,
    Grid,
    Filter,
...
public static class ViewGridDialogChrome
{
    ...
    /// </summary>
    public static void ConfigureStandardDialog(Form form, ViewGridTheme theme, int minimumWidth, int minimumHeight, bool sizeable = true, ViewGridDialogIconKind iconKind = ViewGridDialogIconKind.Grid)
    ...
    /// </summary>
    public static void ConfigureStandardDialog(Form form, ViewGridTheme theme, int minimumSize, bool sizeable = true, ViewGridDialogIconKind iconKind = ViewGridDialogIconKind.Grid)
        => ConfigureStandardDialog(form, theme, new Size(Math.Max(1, minimumSize), Math.Max(1, minimumSize)), sizeable, iconKind);

    public static void ConfigureStandardDialog(Form form, ViewGridTheme theme, Size minimumSize, bool sizeable = true, ViewGridDialogIconKind iconKind = ViewGridDialogIconKind.Grid)
    {
        ...
        form.ShowIcon = iconKind != ViewGridDialogIconKind.None;
        ...
        ViewGridWindowChrome.ApplyOnHandleCreated(form, () => theme, preferGlassWhenAvailable: true);
    ...
    public static void ApplyDialogIcon(Form form, ViewGridTheme theme, ViewGridDialogIconKind iconKind)
    {
        if (form is null || form.IsDisposed || iconKind == ViewGridDialogIconKind.None) return;
        ...
        try
        {
            ...
            form.Icon = ViewGridDialogIconFactory.Create(iconKind, theme);
            form.ShowIcon = true;
        }
        catch
        {
    ...
    public static void ConfigureOpenViewGridDialogs(Control root, ViewGridTheme theme)
    {
        ...
        ViewGridDialogThemeApplier.Apply(root, theme);
    }
}
