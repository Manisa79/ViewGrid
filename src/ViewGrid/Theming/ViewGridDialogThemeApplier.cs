...
/// <summary>
/// Shared visual polish for ViewGrid popup/dialog windows. Keeps helper windows consistent
/// with the active ViewGrid theme without forcing every form to duplicate button/textbox styling.
/// </summary>
public static class ViewGridDialogThemeApplier
{
    public static void Apply(Control root, ViewGridTheme theme)
    {
    ...
    public static void ApplyToControl(Control control, ViewGridTheme theme)
    {
    ...
    public static Color NormalizePanelBack(ViewGridTheme theme)
    {
    ...
    public static Color NormalizeControlBack(ViewGridTheme theme)
    {
    ...
    public static Color NormalizePanelFore(ViewGridTheme theme)
        => EnsureReadableTextColor(theme.ForeColor, NormalizePanelBack(theme));

    public static Color NormalizeControlFore(ViewGridTheme theme)
    ...
    public static void PaintRoundedPanel(Graphics g, Rectangle bounds, ViewGridTheme theme, int radius = 8)
    {
