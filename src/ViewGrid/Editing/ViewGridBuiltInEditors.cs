...
public sealed class DateTimeCellEditor : ICellEditor
{
    public Control CreateEditor(Control owner, Rectangle bounds, ViewGridColumn column, object row, object? value)
    {
        ...
        {
            Format = column.DateTimeFormat == ViewGridDateTimeEditorFormat.Custom ? DateTimePickerFormat.Custom : DateTimePickerFormat.Short,
...
public enum ViewGridDateTimeEditorFormat
{
    Short,
    Custom
}
