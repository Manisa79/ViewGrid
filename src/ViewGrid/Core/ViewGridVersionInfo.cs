...
/// </summary>
public static class ViewGridVersionInfo
{
    public const string ProjectDisplayName = "ViewGrid";
    public const string ControlName = "ViewGridControl";
    public const string PackageId = "ViewGrid.WinForms";
    ...
    public static string AssemblyVersion
        => typeof(ViewGridVersionInfo).Assembly.GetName().Version?.ToString() ?? Version;

    public static string InformationalVersion
        => typeof(ViewGridVersionInfo).Assembly
