...
/// </summary>
public interface IViewGridRangeRowProvider : IRowProvider, IProviderChangeNotifier
{
    int PageSize { get; }
...
public sealed class ViewGridRangeVirtualProvider : IViewGridRangeRowProvider, IDisposable
{
    ...
    public ViewGridRangeVirtualProvider(
    ...
    public object? GetRow(int index)
    {
        ...
        return ViewGridVirtualPlaceholder.Create(index);
    }
...
public sealed record ViewGridVirtualPlaceholder(int Index, string Text)
{
    public static ViewGridVirtualPlaceholder Create(int index) => new(index, "Yükleniyor...");
}
